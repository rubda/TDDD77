...
\newcommand{\LIPSdokument}{Active-set-method}
\newcommand{\LIPSdokumenttyp}{Active-set-method}
...
\LIPSversionsinfo{0.1}{2015-02-21}{Första utkast}{Martin Söderén}{}
...
\input{tex/active-set-method-inledning.tex}
\input{tex/active-set-method-definitioner.tex}
\input{tex/active-set-method-exempel.tex}
