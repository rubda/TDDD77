...
\LIPSversionsinfo{0.1}{2015-04-26}{Första utkast}{Sebastian Fast}{}
...
\input{tex/tekniskdokumentation-anvandargranssnitt.tex}

\begin{appendices}
	\section{Koddokumentation}
	\includepdf[pages=-]{../doxygen/pdf/refman.pdf}
\end{appendices}
