...
\LIPSversionsinfo{0.1}{2015-05-05}{Första utkast}{Sebastian Fast}{}
...
\input{tex/anvandarhandledning-inledning.tex}

\input{tex/anvandarhandledning-installation.tex}

\input{tex/anvandarhandledning-gui.tex}

\input{tex/anvandarhandledning-matlab.tex}

\newpage

\begin{appendices}
\input{tex/anvandarhandledning-bilaga.tex}
\end{appendices}
