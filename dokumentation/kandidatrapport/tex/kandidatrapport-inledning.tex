...
\\ \\
Detta projekt kommer från Saab och stridflygplanet JAS 39 Gripen. I flygplanet används en form av reglering som kallas prediktionsreglering.
\\ \\
...
\subsection{Frågeställning}
	\begin{enumerate}
		...
		\item Vilka erfarenheter är överförbara till kommande projekt?
		\item Har vi noterat någon förbättring av de lärdomar vi dragit från tidigare projekt?
		\item Vilket stöd kan man få genom att använda och följa upp SEMAT Kernel ALPHA:s?
