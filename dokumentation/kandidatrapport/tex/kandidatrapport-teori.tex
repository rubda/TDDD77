...
\textcolor{red}{ skriv om range space}
...
$$Ex = h, \quad Fx \geq h$$
vilket innebär att både $F$ och $g$\textcolor{red}{ vart är g definierad} måste multipliceras med $-1$ för att de ska vara på rätt form. För att uppfylla att $h$ är positiv måste de element däri som är negativa, och motsvarande rad i $E$-matrisen, multipliceras med $-1$.
...
\textcolor{red}{ konstig indexering}
$$x_i = x_{i_1} - x_{i_2}$$
...
\textcolor{red}{ en del av detta ska till metod och där beskriv att det som tar lång tid är att lösa linjära system och beskriv sätt att föbättra detta på. }
