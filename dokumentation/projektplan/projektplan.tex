...
\LIPSversionsinfo{0.1}{2015-02-16}{Första utkast}{Dennis Ljung}{}
\LIPSversionsinfo{0.2}{2015-02-23}{Diverse rättelser samt förtydliganden}{Dennis Ljung}{}
\LIPSversionsinfo{0.3}{2015-03-01}{Komplettering}{Dennis Ljung}{}
...
\begin{appendices}
	...
	\section{$\alpha$-cards}
	\begin{center}
		\includegraphics[angle=90]{grafik/alpha_cards.png}
	\end{center}
\end{appendices}
