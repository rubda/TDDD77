...
\newcommand{\LIPSdokument}{Utvärdering iteration 1}
\newcommand{\LIPSdokumenttyp}{Uvärdering iteration 1}
...
\LIPSversionsinfo{0.1}{2015-03-12}{Första utkast}{Dennis Ljung}{}
\end{LIPSdokumenthistorik}

\newpage
\pagenumbering{arabic}	%Påbörja sidnumrering

\input{tex/utvarderingiteration1-syfte}
\input{tex/utvarderingiteration1-mal}
\input{tex/utvarderingiteration1-utvardering}
\input{tex/utvarderingiteration1-alpha-tillstand}
